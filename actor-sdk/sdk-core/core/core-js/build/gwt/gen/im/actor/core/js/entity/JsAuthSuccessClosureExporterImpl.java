...
public class JsAuthSuccessClosureExporterImpl implements Exporter, im.actor.core.js.entity.JsAuthSuccessClosure {
    ...
    public native void export0() /*-{
      var pkg = @org.timepedia.exporter.client.ExporterUtil::declarePackage(Ljava/lang/String;)('im.actor.core.js.entity.JsAuthSuccessClosure');
      var _;
      $wnd.im.actor.core.js.entity.JsAuthSuccessClosure = $entry(function() {
        var g, j = this;
        if (@org.timepedia.exporter.client.ExporterUtil::isAssignableToInstance(Ljava/lang/Class;Lcom/google/gwt/core/client/JavaScriptObject;)(@im.actor.core.js.entity.JsAuthSuccessClosure::class, arguments))
          g = arguments[0];
        j.g = g;
        @org.timepedia.exporter.client.ExporterUtil::setWrapper(Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(g, j);
        return j;
      });
      _ = $wnd.im.actor.core.js.entity.JsAuthSuccessClosure.prototype = new Object();
      _.onResult = $entry(function(a0) { 
        this.g.@im.actor.core.js.entity.JsAuthSuccessClosure::onResult(Ljava/lang/String;)(a0);
      });
      
      @org.timepedia.exporter.client.ExporterUtil::addTypeMap(Ljava/lang/Class;Lcom/google/gwt/core/client/JavaScriptObject;)
       (@im.actor.core.js.entity.JsAuthSuccessClosure::class, $wnd.im.actor.core.js.entity.JsAuthSuccessClosure);
      
      if(pkg) for (p in pkg) if ($wnd.im.actor.core.js.entity.JsAuthSuccessClosure[p] === undefined) $wnd.im.actor.core.js.entity.JsAuthSuccessClosure[p] = pkg[p];
    }-*/;
