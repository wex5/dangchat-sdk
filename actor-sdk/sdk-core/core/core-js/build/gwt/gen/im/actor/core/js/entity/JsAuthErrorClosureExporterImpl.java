...
public class JsAuthErrorClosureExporterImpl implements Exporter, im.actor.core.js.entity.JsAuthErrorClosure {
    ...
    public native void export0() /*-{
      var pkg = @org.timepedia.exporter.client.ExporterUtil::declarePackage(Ljava/lang/String;)('im.actor.core.js.entity.JsAuthErrorClosure');
      var _;
      $wnd.im.actor.core.js.entity.JsAuthErrorClosure = $entry(function() {
        var g, j = this;
        if (@org.timepedia.exporter.client.ExporterUtil::isAssignableToInstance(Ljava/lang/Class;Lcom/google/gwt/core/client/JavaScriptObject;)(@im.actor.core.js.entity.JsAuthErrorClosure::class, arguments))
          g = arguments[0];
        j.g = g;
        @org.timepedia.exporter.client.ExporterUtil::setWrapper(Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(g, j);
        return j;
      });
      _ = $wnd.im.actor.core.js.entity.JsAuthErrorClosure.prototype = new Object();
      _.onError = $entry(function(a0,a1,a2,a3) { 
        this.g.@im.actor.core.js.entity.JsAuthErrorClosure::onError(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)(a0,a1,a2,a3);
      });
      
      @org.timepedia.exporter.client.ExporterUtil::addTypeMap(Ljava/lang/Class;Lcom/google/gwt/core/client/JavaScriptObject;)
       (@im.actor.core.js.entity.JsAuthErrorClosure::class, $wnd.im.actor.core.js.entity.JsAuthErrorClosure);
      
      if(pkg) for (p in pkg) if ($wnd.im.actor.core.js.entity.JsAuthErrorClosure[p] === undefined) $wnd.im.actor.core.js.entity.JsAuthErrorClosure[p] = pkg[p];
    }-*/;
